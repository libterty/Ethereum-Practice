    ...
    describe('validateBlock()', () => {
      ...
      it('rejects when the parentHash is invalid', () => {
        ...
        expect(
          ...
          message: "The parent hash must be a hash of the last block's header"
        });
      });
      ...
      it('rejects when the number is not increased by one', () => {
        ...
        expect(
          ...
          message: 'The block mush increment the number by 1'
        });
      });

      it('rejects when the difficulty adjust by more then one', () => {

...
describe('Transaction', () => {
  ...
  describe('validateStandardTransaction()', () => {
    it('validates a valid transaction', () => {
      expect(
        Transaction.validateStandrdTransaction({
    ...
    it('does not validates a malformed transaction', () => {
    ...
    it('does not validate when the value execeeds the balance', () => {
      standardTransaction = Transaction.createTransaction({
        account,
        to: toAccount.address,
        value: 9001
    ...
    it('does not validate wehn the gasUsed for the code exceeds the gasLimit', () => {
  ...
  describe('validateMiningRewardTransaction()', () => {
    ...
    it('does not validate a mining reward transaction', () => {
